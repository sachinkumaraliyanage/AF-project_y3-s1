...
const chsubmit = function (val) {
    ...
    let ur = "http://localhost:5000/course/" + val.cid+ "/" + val.enrollkey+ "/" + 'yes';
    let ur2= "http://localhost:5000/studentenroll/confirm/" + val.cid+ "/" + val.semail;
            ...
            try {
                ...
                axios.get(ur).then(res => {
                    ...
                    if (coursedata == null) {
                        ...
                        axios.post('http://localhost:5000/studentenroll/add', val)
                        ...
                        <Form.Row>
                            ...
                            <Form.Group as={Col} md="4" controlId="validationFormik02">
                                ...
                                <Form.Control
                                    ...
                                    onChange={handleChange}
                                    isValid={touched.enrollkey && !errors.enrollkey}
                                />
                                <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                            </Form.Group>
                        </Form.Row>
