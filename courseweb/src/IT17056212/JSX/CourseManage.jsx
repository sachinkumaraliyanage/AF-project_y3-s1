        ...
        buttons: [
            {
                label: 'Yes',
                onClick: () => {
                    let ur = "http://localhost:5000/course/"+cid;
                    let ur2 = "http://localhost:5000/courseinstructor/"+cid;
                    let ur3 = "http://localhost:5000/studentenroll/"+cid;
...
export default class CourseManage extends Component {
    ...
    async componentDidMount(){
        ...
        let course2;
        console.log("3");
        let ur = "http://localhost:5000/course/";
